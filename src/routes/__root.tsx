    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-medium text-primary-foreground"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Technogate — Technology, Innovation, Solutions" },
      {
        name: "description",
        content:
          "Technogate is an enterprise technology studio building custom software, prototypes, interfaces and performance marketing systems.",
      },
      { name: "author", content: "Technogate" },
